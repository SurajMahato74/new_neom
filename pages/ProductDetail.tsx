      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-4">
          <div className="aspect-square bg-white border border-gray-100 rounded-2xl p-10 relative group overflow-hidden">
            <img 
              src="/static/img/products/helen_harper_4.jpeg" 
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="aspect-square bg-white border border-gray-100 rounded-xl overflow-hidden cursor-pointer hover:border-[#0d7ff2] transition-colors p-2">
              <img src="/static/img/products/helen_5.jpeg" className="w-full h-full object-cover rounded-lg" alt="Helen Harper" />
            </div>
            <div className="aspect-square bg-white border border-gray-100 rounded-xl overflow-hidden cursor-pointer hover:border-[#0d7ff2] transition-colors p-2">
              <img src="/static/img/products/babycharm_1_newborn.jpeg" className="w-full h-full object-cover rounded-lg" alt="Baby Charm Newborn" />
            </div>
            <div className="aspect-square bg-white border border-gray-100 rounded-xl overflow-hidden cursor-pointer hover:border-[#0d7ff2] transition-colors p-2">
              <img src="/static/img/products/babycharm_4_maxi.jpeg" className="w-full h-full object-cover rounded-lg" alt="Baby Charm Maxi" />
            </div>
