        ...
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { id: 'helen-harper-adult-care', name: "Helen Harper Adult Care", desc: "Premium comfort for active lifestyles.", image: "/static/img/products/helen_5.jpeg" },
                { id: 'baby-charm-newborn', name: "Baby Charm Newborn", desc: "Ultra-soft protection for newborns.", image: "/static/img/products/babycharm_1_newborn.jpeg" },
                { id: 'baby-charm-maxi', name: "Baby Charm Maxi", desc: "Perfect fit for growing babies.", image: "/static/img/products/babycharm_4_maxi.jpeg" },
                { id: 'helen-harper-premium', name: "Helen Harper Premium", desc: "Dignity and comfort for adults.", image: "/static/img/products/helen_harper_4.jpeg" }
              ].map((product, i) => (
